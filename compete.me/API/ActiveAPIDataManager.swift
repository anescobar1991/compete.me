...
//TODO this class will send signal if success or send error signal if error
class ActiveAPIDataManager {
  private let apiKey = "eb86wy9qnhuje6n6jndfzy72"
  private let hostName = "https://api.amp.active.com/v2/search/"
